...
Enter the version constraint to require (or leave blank to use the latest version): ^{{% siteparam "currentContaoVersion" %}}
...

{
    ...
    "type": "contao-bundle",
    "require": {
        "contao/core-bundle": "^{{% siteparam "currentContaoVersion" %}}"
    },
    "license": "LGPL-3.0-or-later",
    "autoload": {
        "psr-4": {
